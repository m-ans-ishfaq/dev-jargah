    ...
    return (
        <section className="w-full mt-8 relative flex flex-col items-center">
            ...
            <div className="w-full relative py-12 sm:py-0 sm:-top-20 z-[3] sm:pt-40">
                <Image src={Hexagon} alt="" className="absolute w-full h-full sm:h-[calc(100%+80px)] top-0 left-0 z-0 object-cover" />
                <div className="absolute w-full h-full sm:h-[calc(100%+80px)] top-0 left-0 z-[1] bg-black bg-opacity-80 object-cover" />
