...
export function QUA()
{
    ...
    return (
        <section className="flex justify-center items-center h-[40vh] min-h-[32rem] bg-black relative px-4">
            ...
            <div className="relative py-8 px-8 bg-white backdrop-blur-sm bg-opacity-65 rounded-md w-full max-w-5xl grid grid-cols-4 divide-x divide-neutral-500 border-neutral-400 border">
                {content.aboutUs.details.map(({label, value}, i) => (
                    <div key={i} className="py-4 w-full h-full flex items-center flex-col justify-center">
                        <h5 className="font-bold text-4xl">{value}</h5>
